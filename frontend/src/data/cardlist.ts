...
export const CARDLIST: TImageCard[] = [
  {
    ...
    alt: "",
    description: "L'affectation consiste à donner une valeur à une variable. On parle d'initialisation lorsque c'est la première fois que la variable reçoit une valeur.",
  ...
  },
  {
    ...
    src: "/assets/bit3.png",
    alt: "",
    description: "En informatique Un bit est l’unité de base de l’information. Il peut prendre deux valeurs : 0 ou 1, représentant les états de \"faux\" ou \"vrai\", \"éteint\" ou \"allumé\".",
    author: "Fabien Poirier",
    category: "Type",
  },
  {
  ...
  {
    id: 7,
    name: "Boucle (fonctionnement)",
    src: "/assets/boucle.png",
    alt: "",
    description: "Une boucle est une structure de contrôle qui permet de répéter une série d'instructions plusieurs fois. À chaque répétition, appelée \"itération,\" une variable (appelée itérateur) compte le nombre de tours effectués celui-ci évolue à chaque tour selon un pas. La boucle continue jusqu'à ce que la condition de fin soit atteinte.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    src: "/assets/byte.png",
    alt: "",
    description: "Un byte aussi appelé \"octet\" en français est une unité de mesure informatique qui regroupe 8 bits.",
    author: "Fabien Poirier",
    category: "Structure de données",
  },
  {
  ...
  {
    id: 12,
    name: "Texte vs Nombre",
    src: "/assets/char_vs_int.png",
    alt: "",
    description: "Bien qu'ils puissent tous contenir des chiffres, un String est généralement utilisé pour représenter du texte affichable, tandis que les types int et float sont conçus pour stocker des nombres entiers (int) ou décimaux (float) afin de réaliser des calculs.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "En Programmation Orientée Objet (POO), une classe est une structure qui définit un type d'objet, encapsulant des données (sous forme d'attributs) et des comportements (sous forme de méthodes). Une classe sert de modèle pour créer des objets.",
    author: "Fabien Poirier",
    category: "POO",
  },
  {
    ...
    alt: "",
    description: "En Programmation Orientée Objet (POO), une classe peut être considérée comme un plan permettant de créer un type d'objet, en précisant ses attributs et les actions qu'il peut effectuer. Lorsque l'on crée un objet à partir d'une classe, cet objet est alors qualifié d'instance de cette classe.",
    author: "Fabien Poirier",
    category: "POO",
  },
  {
    ...
    alt: "",
    description: "En Programmation Orientée Objet (POO), une classe peut être vue comme une recette définissant un type d'objet, en spécifiant ses caractéristiques et son comportement. Lorsqu'un objet est créé à partir de cette classe, on appelle celui-ci une instance.",
    author: "Fabien Poirier",
    category: "POO",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "Une collection est une structure de données qui regroupe plusieurs éléments, souvent de même type, afin de les manipuler de manière efficace.",
    author: "Fabien Poirier",
    category: "Structure de données",
  },
  {
  ...
  {
    id: 20,
    name: "Compiler / Compilateur",
    src: "/assets/compiler.png",
    alt: "",
    description: "Un compilateur est un programme qui traduit le code source écrit dans un langage de programmation de haut niveau en un code compréhensible par l'ordinateur.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    alt: "",
    description: "La concaténation est l'opération qui consiste à mettre bout à bout deux chaînes de caractères pour en former une seule.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    alt: "",
    description: "Dans un programme une condition est une règle qui permet de prendre des décisions. Elle vérifie si quelque chose est vrai ou faux.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    alt: "",
    description: "Une condition est une règle qui permet de prendre des décisions. Elle vérifie si une affirmation est vraie ou fausse. Selon la manière dont la condition est définie, il est possible d'exécuter un traitement différent selon qu'elle soit remplie ou non.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    alt: "",
    description: "La condition ternaire est une ecriture particulière permettant de décider entre deux valeurs selon si une condition est vraie ou fausse.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    id: 25,
    name: "Connecteur logique / Opérateur logique",
    src: "/assets/connecteur_logique.png",
    alt: "",
    description: "Un connecteur logique ou opérateur logique est un mot ou un symbole qui relie des idées ou des conditions.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    alt: "",
    description: "Un constructeur est une méthode spéciale qui est utilisée pour créer et initialiser des objets.",
    author: "Fabien Poirier",
    category: "POO",
  },
  {
    id: 27,
    name: "Déclarer / Déclaration",
  ...
  },
  {
    ...
    alt: "",
    description: "En programmation, le terme \"deprecated\" (ou \"obsolète\", \"déprecié\" en français) désigne une fonctionnalité, une méthode ou une API qui est encore présente dans le code mais qui est déconseillée à utiliser. ",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "L'encapsulation est un principe de la Programmation Orientée Objet (POO) qui consiste à protéger les données d'un objet en les rendant privées et en contrôlant l'accès à ces données via des méthodes publiques. Cela signifie que l'on peut cacher les détails internes d'un objet tout en permettant d'interagir avec lui de manière sécurisée.",
    author: "Fabien Poirier",
    category: "POO",
  },
  {
  ...
  },
  {
    ...
    src: "/assets/et.png",
    alt: "",
    description: "En programmation, \"ET\" est un opérateur logique utilisé pour combiner deux conditions. Il permet de vérifier si les deux conditions sont vraies en même temps.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "L'opérateur modulo, souvent représenté par le symbole %, détermine le reste d'une division entre deux nombres, contrairement à une division classique qui donne le quotient.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "En programmation orientée objet, \"override\" implique de passer outre les instructions définies par défaut d'une méthode et les remplacer par une nouvelle version définie dans l'une des classes dérivées (ou sous-classes).",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "Le passage par copie (ou \"pass by value\" en anglais) signifie que lorsque vous transmettez une variable à une méthode, une copie de la valeur de cette variable est faite.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "En programmation orientée objet, le polymorphisme permet de données à un objet plusieurs forme. ",
    author: "Fabien Poirier",
    category: "POO",
  },
  {
    ...
    alt: "",
    description: "Le polymorphisme est un concept en programmation orientée objet qui permet à un même objet ou morceau de code d'agir différemment selon la situation.",
    author: "Fabien Poirier",
    category: "POO",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "Le mot-clé continue est utilisé dans une boucle pour passer immédiatement au tour suivant, en sautant le reste du code qui suit cette instruction.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    alt: "",
    description: "Dans une boucle le mot-clé break est utilisé pour arreter immédiatement la boucle.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "L'affectation consiste à donner une valeur à une variable.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    alt: "",
    description: "L'apprentissage par renforcement est une méthode d'intelligence artificielle dans laquelle un agent (un programme) apprend en interagissant avec un environnement et en recevant des récompenses ou des punitions en fonction de ses actions. L'agent explore différentes actions pour maximiser ses récompenses et atteindre un objectif. À travers des essais et des erreurs, il découvre progressivement les meilleures stratégies pour accomplir sa tâche. C'est une méthode inspirée de l'apprentissage humain, où l'expérience guide l'optimisation du comportement.",
    author: "Fabien Poirier",
  ...
  },
  {
    ...
    alt: "",
    description: "Un arbre de décision est un modèle graphique utilisé en apprentissage automatique et en statistiques pour prendre des décisions ou classer des données. Il représente une série de choix sous forme d'une structure arborescente, où chaque nœud correspond à une condition ou un critère, chaque branche représente le résultat de cette condition, et chaque feuille (ou nœud terminal) indique une décision ou une classe.",
    author: "Fabien Poirier",
  ...
  },
  {
    ...
    alt: "",
    description: "En deep learning, un batch (ou lot en français) désigne un ensemble de données d'entraînement utilisé pour mettre à jour les poids d'un modèle lors d'une itération de l'apprentissage.",
    author: "Fabien Poirier",
    category: "Machine Learning",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "La méthode brute force est une approche utilisée pour résoudre des problèmes en essayant toutes les solutions possibles jusqu'à trouver la bonne.",
    author: "Fabien Poirier",
  ...
  },
  {
    ...
    alt: "",
    description: "Le debugging (ou débogage en français) est le processus de recherche et de correction des erreurs, ou \"bugs\", dans un programme informatique.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "Le hachage est un processus qui transforme une entrée, comme un mot de passe ou un fichier, en une valeur de hachage, rendant ainsi l'entrée originale illisible. Cette méthode est souvent utilisée pour sécuriser les mots de passe, car il est presque impossible de retrouver l'entrée originale à partir de sa valeur de hachage. Le salage, quant à lui, est effectué en complément du hachage et consiste à ajouter une chaîne aléatoire aux données d'entrée. Cela rend encore plus difficile la récupération des données d'origine.",
    author: "Fabien Poirier",
    category: "Cyber sécurité",
  },
  {
  ...
  },
  {
    ...
    src: "/assets/man_in_the_middle.png",
    alt: "",
    description: "Le man-in-the-middle (ou \"homme du milieu\") est un type d'attaque informatique où un tiers malveillant intercepte et peut manipuler les communications entre deux parties qui pensent communiquer directement l'une avec l'autre.",
    author: "Fabien Poirier",
    category: "Cyber sécurité",
  },
  {
    ...
    alt: "",
    description: "Le modulo est une opération mathématique qui calcule le reste d'une division entre deux nombres.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "Un pointeur est une variable qui stocke l'adresse mémoire d'une autre variable. Plutôt que de contenir directement une valeur, un pointeur indique où la valeur pointé se trouve en mémoire.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    alt: "",
    description: "Un réseau de neurones est un modèle d'intelligence artificiel inspiré du fonctionnement du cerveau humain organisée en couches, chacune réalisant un type de traitement différent et conçu pour traiter des informations et résoudre des problèmes complexes, tels que la reconnaissance d'images ou la prédiction de données.",
    author: "Fabien Poirier",
    category: "Deep Learning",
  },
  {
    ...
    alt: "",
    description: "Un sémaphore est un outil utilisé en informatique pour contrôler l'accès à une ressource partagée par plusieurs processus ou threads.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    alt: "",
    description: "Contrairement à une méthode de classe, une méthode statique est une méthode définie dans une classe qui peut être appelée directement sans passer par un intermédiaire, c'est-à-dire sans avoir à créer un objet de cette classe.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    id: 128,
    name: "Apprentissage Supervisé (Objectif)",
  ...
  },
  {
    ...
    alt: "",
    description: "L'apprentissage supervisé est une méthode d'apprentissage automatique où un modèle est formé à partir d'exemples préalablement étiquetés. Cela signifie que pour chaque donnée d'entrée (comme une image ou un texte), le modèle reçoit également la réponse correcte ou la catégorie à laquelle elle appartient.",
    author: "Fabien Poirier",
    category: "Deep Learning",
  },
  {
    ...
    alt: "",
    description: "La surcharge permet d'effectuer la même action (appel d'une méthode) de différentes manières selon le contexte.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    ...
    src: "/assets/swap.png",
    alt: "",
    description: "Le swap est une opération qui consiste à échanger la position de deux éléments.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
  ...
  },
  {
    ...
    alt: "",
    description: "Un type primitif est une catégorie de données de base proposé par un langage de programmation représentant des types de données simples, ne peuvant être décomposés en d'autres types.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
    id: 135,
    name: "Entraînement non supervisé (Objectif)",
  ...
  },
  {
    ...
    alt: "",
    description: "L'apprentissage non supervisé est une méthode d'apprentissage automatique où un modèle est formé à partir de données sans étiquettes ou réponses connues. Dans ce cas, le modèle examine les données et cherche à en comprendre les structures ou les motifs, sans qu'on lui indique ce qu'il doit rechercher.",
    author: "Fabien Poirier",
    category: "Deep Learning",
  },
  {
    ...
    alt: "",
    description: "Une variable est un espace mémoire identifié par un nom qui peut contenir une valeur.",
    author: "Fabien Poirier",
    category: "Programmation",
  },
  {
